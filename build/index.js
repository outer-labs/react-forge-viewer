...
var _reactLoadScript = __webpack_require__(3);
...
var ForgeViewer = function (_React$Component) {
  ...
  _createClass(ForgeViewer, [{
    ...
    value: function handleLoadDocumentSuccess(doc) {
      ...
      if (this.props.onDocumentLoad) this.props.onDocumentLoad(doc, viewables);
    }
  }, {
    ...
    value: function componentDidUpdate(prevProps, prevState) {
      ...
      if (this.props.view != prevProps.view) {
        if (!this.state.doc) {
          ...
          var svfUrl = this.state.doc.getViewablePath(view);
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement('link', { rel: 'stylesheet', type: 'text/css', href: 'https://developer.api.autodesk.com/modelderivative/v2/viewers/style.min.css?v=v5.0' }),
        _react2.default.createElement(_reactLoadScript2.default, { url: 'https://developer.api.autodesk.com/modelderivative/v2/viewers/viewer3D.min.js?v=v5.0',
        ...
        !this.state.doc ? _react2.default.createElement(
          'div',
          { className: 'scrim' },
          _react2.default.createElement(
            'div',
